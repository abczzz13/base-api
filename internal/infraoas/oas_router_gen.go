		...
		case '/': // Prefix: "/"
			...
			case 'l': // Prefix: "livez"
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "GET":
						s.handleGetLivezRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, "GET")
					}
		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "healthz"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Service health summary endpoint"
			...
			case 'l': // Prefix: "livez"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "GET":
						r.name = GetLivezOperation
						r.summary = "Liveness probe endpoint"
						r.operationID = "getLivez"
						r.operationGroup = "Infra"
						r.pathPattern = "/livez"
						r.args = args
						r.count = 0
			...
			case 'r': // Prefix: "readyz"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Readiness probe endpoint"
