...
func TestSetupDatabaseValidation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			database, shutdown, err := setupDatabase(context.Background(), tt.cfg, tt.registerer)
			if database != nil {
...
func TestSetupDatabaseRetriesOpenFailuresAndExhaustsAttempts(t *testing.T) {
	...
	database, shutdown, err := setupDatabase(context.Background(), cfg, registerer)
	if database != nil {
...
func TestIsRetryableDatabaseOpenError(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			ctx:  context.Background(),
			err:  postgres.ErrDatabaseURLRequired,
			want: false,
		},
		{
			name: "invalid database URL is not retryable",
			ctx:  context.Background(),
			err:  postgres.ErrInvalidDatabaseURL,
			want: false,
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := isRetryableDatabaseOpenError(tt.ctx, tt.err); got != tt.want {
...
func TestIsRetryableDatabaseMigrateError(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := isRetryableDatabaseMigrateError(tt.ctx, tt.err); got != tt.want {
...
func TestDatabaseStartupRetryDelay(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := databaseStartupRetryDelay(tt.initial, tt.max, tt.attempt); got != tt.want {
